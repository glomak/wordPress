...
/*----------------------------------------------------------------------------------------------------------------------------------------*/
     ...
     * @access public
     */
    class Yaatra_Toggle_Checkbox_Custom_Control extends WP_Customize_Control {
...
/*----------------------------------------------------------------------------------------------------------------------------------------*/
     ...
     * @access public
     */
    class Yaatra_Customize_Control_Radio_Image extends WP_Customize_Control {
        /**
...
/*--------------------------------------------------------------------------------------------------------------*/
     ...
     */
    class Yaatra_Customize_Multiple_Checkboxes_Control extends WP_Customize_Control {
        /**
         * The type of customize control being rendered.
         *
         * @since  1.0.0
...
/*----------------------------------------------------------------------------------------------------------------------------------------*/
     ...
     * @since 1.0.0
     */
    class Yaatra_Repeater_Controler extends WP_Customize_Control {
        /**
         * The control type.
         *
         * @access public
        ...
        public $yaatra_box_label = '';

        public $yaatra_box_add_control = '';
        ...
        public function __construct( $manager, $id, $args = array(), $fields = array() ) {
            $this->fields = $fields;
            $this->yaatra_box_label = $args['yaatra_box_label'] ;
            $this->yaatra_box_add_control = $args['yaatra_box_add_control'];
        ...
        ?>
            ...
            <button type="button" class="button cv-repeater-add-control-field"><?php echo esc_html( $this->yaatra_box_add_control ); ?></button>
    <?php
        }

        private function yaatra_get_fields(){
            $fields = $this->fields;
            $values = json_decode( $this->value() );
        ...
        ?>
	            ...
	            <h3 class="cv-repeater-field-title"><?php echo esc_html( $this->yaatra_box_label ); ?></h3>
	            ...
	            ?>
	                ...
	                <?php 
	                    ...
	                    switch ( $field['type'] ) {
                             ...
                             */
                            case 'social_icon':
                                $yaatra_font_awesome_social_icon_array = yaatra_font_awesome_social_icon_array();
	                            ...
	                            foreach ( $yaatra_font_awesome_social_icon_array as $yaatra_font_awesome_icon ) {
	                                $icon_class = $new_value == $yaatra_font_awesome_icon ? 'icon-active' : '';
	                                echo '<li class='.esc_attr( $icon_class ).'><i class="'.esc_attr( $yaatra_font_awesome_icon ).'"></i></li>';
	                            }
            ...
            ?>
	                <div class="cv-clearfix cv-repeater-footer">
	                    ...
	                    <a class="cv-repeater-field-remove" href="#remove"><?php esc_html_e( 'Delete', 'yaatra' ) ?></a> |
	                    <a class="cv-repeater-field-close" href="#close"><?php esc_html_e( 'Close', 'yaatra' ) ?></a>
	                    </div>
